 ...
 * 2016-06-13T23:22:20.301-03:00
 * Generated source version: 2.7.13
 * 
 */
@WebServiceClient(name = "EstoqueWSService", 
                  wsdlLocation = "file:/C:/Users/Gustavo/workspace/EstoqueWSWeb/src/estoquews.wsdl",
...
public class EstoqueWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Gustavo/workspace/EstoqueWSWeb/src/estoquews.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EstoqueWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Gustavo/workspace/EstoqueWSWeb/src/estoquews.wsdl");
        }
        WSDL_LOCATION = url;
    }
